    ...
    <nav id="header" tw="w-full z-30 top-0 py-1">
      <div tw="w-full mx-auto flex flex-wrap items-center justify-between mt-0 px-6 py-3">
        ...
        <div tw="hidden md:flex md:items-center md:w-auto w-full order-3 md:order-1 peer-checked:block">
          <nav>
            <ul tw="md:flex items-center justify-between text-base text-gray-700 pt-4 md:pt-0">
              <li>
                <a
                  tw="inline-block no-underline hover:text-black hover:underline py-2 px-4"
                  href="#"
                >
                  Shop
                </a>
        ...
        <div tw="order-1 md:order-2">
          <a
            tw="flex items-center tracking-wide no-underline hover:no-underline font-bold text-gray-800 text-xl "
            href="#"
          >
            <svg
        ...
        <div tw="order-2 md:order-3 flex items-center" id="nav-content">
          <a tw="inline-block no-underline hover:text-black" href="#">
            <svg
