    ...
    <section tw="bg-white py-8">
      <div tw="container mx-auto flex items-center flex-wrap pt-4 pb-12">
        ...
        {items.map((data, index) =>
          isEditEnable ? (
            <AdminAddItem data={data} key={data.id + index} />
          ) : (
            <SingleItemSmall data={data} key={data.id + index} />
          )
        )}
        ...
        >
          <a href="#">
            <img
              alt="Image-Section"
              tw="hover:flex-grow hover:shadow-lg"
              src="https://images.unsplash.com/photo-1555982105-d25af4182e4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&h=400&q=80"
            />
            <div tw="pt-3 flex items-center justify-between">
              <p tw="">Product Name</p>
              <svg
                tw="h-6 w-6 fill-current text-gray-500 hover:text-black"
            ...
            <p tw="pt-1 text-gray-900">£9.99</p>
          </a>
        </div>
        <div tw="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
          <a href="#">
            <img
              alt="Image-Section"
              tw="hover:flex-grow hover:shadow-lg"
